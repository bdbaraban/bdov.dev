...
const HomeSection = () => (
  <Section>
    ...
    <Text>
      ...
      we engineers like to believe will flood our personal sites with
      life-changing job offers, or, most likely, you a bot trying to scrape some
      juicy personal data - regardless, welcome.
    </Text>
    <Text>
